...
// Adjective ranking + euphony rules live in titleEuphony.js so the
...
const CREATURE_DESCRIPTIONS = {
  ...
  Dove: "Soft gray peace-bird with wings folded close.",
  ...
  Wolf: "Gray pack-runner with steady amber eyes.",
  ...
  Mockingbird: "Gray trickster singing in a dozen borrowed voices.",
  ...
  Canary: "Small song-bird the color of a bright window.",
  ...
  "Eight-Legged Steed": "Eight-legged gray horse of old northern legend, fastest mount between worlds.",
