...
const CREATURE_DESCRIPTIONS = {
  ...
  Garuda: "Eagle-king of South Asian myth, mount of Vishnu and slayer of serpents.",
  ...
  Buraq: "White winged steed of Islamic tradition with a peacock's tail.",
  ...
  Behemoth: "Hippopotamus-large beast of biblical legend, set alongside the sea-Leviathan.",
  ...
  Tarasque: "Six-legged dragon-turtle hybrid of Provençal legend, tamed by a saint with a ribbon.",
  ...
  Melissa: "Honey-priestess nymph of Greek myth, attended by bees.",
  ...
  Greenman: "Leaf-faced spirit of British church carvings, presiding over the green wood.",
