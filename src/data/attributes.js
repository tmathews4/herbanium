...
export const ATTRIBUTES = [
  ...
  { id: "the-polyglot-mouth", name: "The Polyglot Mouth", rarity: "rare", window: "onboarding",
    glyph: "compass", tint: "plum", frame: "diamond", accent: "rays",
    desc: "A wide palate, hungry for range. The cup speaks every dialect.",
  ...
  { id: "the-mood-reader",   name: "The Mood-Reader",    rarity: "uncommon", window: "onboarding",
    glyph: "compass", tint: "ochre", frame: "circle", accent: "rays",
    desc: "You read the room before the cup. Feeling leads, flavor follows.",
  ...
  { id: "spirit-bear",        name: "The Bear",           rarity: "uncommon", window: "onboarding",
    glyph: "grounding", tint: "terra", frame: "hex", accent: "none",
    desc: "Den of root and bark. You take the cup like a long sleep.",
    earned: ctx => onPick(ctx, "comfort", ["earthy"]) },
  { id: "spirit-otter",       name: "The Otter",          rarity: "common", window: "onboarding",
    glyph: "comfort", tint: "ochre", frame: "circle", accent: "dot",
    desc: "Playful warmth. The cup is a swim through summer.",
  ...
  { id: "spirit-cardinal",    name: "The Cardinal",       rarity: "uncommon", window: "onboarding",
    ...
    desc: "Bright against winter. A flash of red on the bare branch.",
  ...
  { id: "spirit-salmon",      name: "The Salmon",         rarity: "rare", window: "onboarding",
    ...
    desc: "Return upstream. The cup smells of home in the woods.",
    earned: ctx => onPick(ctx, "comfort", ["smoky"]) },
  { id: "spirit-owl",         name: "The Owl",            rarity: "rare", window: "onboarding",
    glyph: "sleepy", tint: "plum", frame: "hex", accent: "crescent",
    desc: "Twilight wisdom. You see best when the lamps are out.",
  ...
  { id: "spirit-whale",       name: "The Whale",          rarity: "legendary", window: "onboarding",
    ...
    desc: "Deep, slow, ancient. The cup is a long song under dark water.",
    earned: ctx => onPick(ctx, "sleepy", ["earthy"]) },
  { id: "spirit-lynx",        name: "The Lynx",           rarity: "legendary", window: "onboarding",
    glyph: "cooling", tint: "sky", frame: "diamond", accent: "crescent",
    desc: "Solitary in the cold. Few choose this path; you walk it quiet.",
  ...
  { id: "spirit-bee",         name: "The Bee",            rarity: "common", window: "onboarding",
    ...
    desc: "The kettle is your hive. The cup is your daily honey.",
    earned: ctx => onPick(ctx, "energy", ["sweet"]) },
  { id: "spirit-hummingbird", name: "The Hummingbird",    rarity: "rare", window: "onboarding",
    glyph: "uplifting", tint: "ochre", frame: "circle", accent: "rays",
    desc: "Quick joy in petals. The cup is a thousand small wingbeats.",
  ...
  { id: "spirit-robin",       name: "The Robin",          rarity: "uncommon", window: "onboarding",
    ...
    desc: "The spring breast. Cups taste like rain ending.",
    earned: ctx => onPick(ctx, "energy", ["fruity"]) },
  { id: "spirit-boar",        name: "The Boar",           rarity: "uncommon", window: "onboarding",
    glyph: "warming", tint: "terra", frame: "hex", accent: "none",
    desc: "Robust and rooted. Forward, but never lifted off the ground.",
  ...
  { id: "spirit-fox",         name: "The Fox",            rarity: "uncommon", window: "onboarding",
    ...
    desc: "Clever and bright. The cup sharpens the eye to red leaves.",
  ...
  { id: "spirit-hawk",        name: "The Hawk",           rarity: "uncommon", window: "onboarding",
    ...
    desc: "Keen warmth. The cup scans the field and steadies the hand.",
  ...
  { id: "spirit-beaver",      name: "The Beaver",         rarity: "uncommon", window: "onboarding",
    ...
    desc: "Patient builder. Slow river, steady cup, finished dam.",
  ...
  { id: "spirit-bat",         name: "The Bat",            rarity: "legendary", window: "onboarding",
    ...
    desc: "Twilight emergence. Petals at the wing's edge.",
    earned: ctx => onPick(ctx, "sleepy", ["floral"])
  ...
  { id: "spirit-elephant",    name: "The Elephant",       rarity: "rare", window: "onboarding",
    ...
    desc: "Old memory, slow trunk. The cup that remembers.",
