...
export const ATTRIBUTES = [
  ...
  // ─── Spirit animals — onboarding combos rendered as totem creatures.
  //     Animals pair with mood × flavor archetypes the way totems pair
  //     with personalities. A single user can land several. ──────────
  { id: "spirit-bear",        name: "The Bear",           rarity: "uncommon", window: "onboarding",
    glyph: "grounding", tint: "terra", frame: "hex", accent: "none",
    desc: "Comfort and earthy — den of root and bark. You take the cup like a long sleep.",
    earned: ctx => onPick(ctx, "comfort", ["earthy"]) },
  { id: "spirit-otter",       name: "The Otter",          rarity: "common", window: "onboarding",
    glyph: "comfort", tint: "ochre", frame: "circle", accent: "dot",
    desc: "Comfort and fruity — playful warmth, the cup as a swim through summer.",
    earned: ctx => onPick(ctx, "comfort", ["fruity"]) },
  { id: "spirit-cardinal",    name: "The Cardinal",       rarity: "uncommon", window: "onboarding",
    glyph: "uplifting", tint: "terra", frame: "circle", accent: "rays",
    desc: "Comfort and citrus — bright against winter, a flash of red on the bare branch.",
    earned: ctx => onPick(ctx, "comfort", ["citrus"]) },
  { id: "spirit-salmon",      name: "The Salmon",         rarity: "rare", window: "onboarding",
    glyph: "warming", tint: "terra", frame: "diamond", accent: "rays",
    desc: "Comfort and smoky — return upstream, the cup that smells of home in the woods.",
    earned: ctx => onPick(ctx, "comfort", ["smoky"]) },
  { id: "spirit-owl",         name: "The Owl",            rarity: "rare", window: "onboarding",
    glyph: "sleepy", tint: "plum", frame: "hex", accent: "crescent",
    desc: "Sleepy and smoky — twilight wisdom. You see best when the lamps are out.",
    earned: ctx => onPick(ctx, "sleepy", ["smoky"]) },
  { id: "spirit-whale",       name: "The Whale",          rarity: "legendary", window: "onboarding",
    glyph: "grounding", tint: "plum", frame: "diamond", accent: "rays",
    desc: "Sleepy and earthy — deep, slow, ancient. The cup is a long song under dark water.",
    earned: ctx => onPick(ctx, "sleepy", ["earthy"]) },
  { id: "spirit-lynx",        name: "The Lynx",           rarity: "legendary", window: "onboarding",
    glyph: "cooling", tint: "sky", frame: "diamond", accent: "crescent",
    desc: "Sleepy and minty — solitary in the cold. Few choose this path; you walk it quiet.",
    earned: ctx => onPick(ctx, "sleepy", ["minty"]) },
  { id: "spirit-bee",         name: "The Bee",            rarity: "common", window: "onboarding",
    glyph: "bee", tint: "ochre", frame: "circle", accent: "dot",
    desc: "Energy and sweet — the kettle is your hive, the cup your daily honey.",
    earned: ctx => onPick(ctx, "energy", ["sweet"]) },
  { id: "spirit-hummingbird", name: "The Hummingbird",    rarity: "rare", window: "onboarding",
    glyph: "uplifting", tint: "ochre", frame: "circle", accent: "rays",
    desc: "Energy and floral — quick joy in petals. The cup is a thousand small wingbeats.",
    earned: ctx => onPick(ctx, "energy", ["floral"]) },
  { id: "spirit-robin",       name: "The Robin",          rarity: "uncommon", window: "onboarding",
    glyph: "uplifting", tint: "terra", frame: "circle", accent: "dot",
    desc: "Energy and fruity — the spring breast. Cups taste like rain ending.",
    earned: ctx => onPick(ctx, "energy", ["fruity"]) },
  { id: "spirit-boar",        name: "The Boar",           rarity: "uncommon", window: "onboarding",
    glyph: "warming", tint: "terra", frame: "hex", accent: "none",
    desc: "Energy and earthy — robust and rooted. Forward, but never lifted off the ground.",
    earned: ctx => onPick(ctx, "energy", ["earthy"]) },
  { id: "spirit-fox",         name: "The Fox",            rarity: "uncommon", window: "onboarding",
    glyph: "focus", tint: "ochre", frame: "circle", accent: "rays",
    desc: "Focus and citrus — clever and bright. The cup sharpens the eye to red leaves.",
    earned: ctx => onPick(ctx, "focus", ["citrus"]) },
  { id: "spirit-hawk",        name: "The Hawk",           rarity: "uncommon", window: "onboarding",
    glyph: "focus", tint: "terra", frame: "diamond", accent: "rays",
    desc: "Focus and spiced — keen warmth. The cup scans the field and the cup steadies the hand.",
    earned: ctx => onPick(ctx, "focus", ["spiced"]) },
  { id: "spirit-beaver",      name: "The Beaver",         rarity: "uncommon", window: "onboarding",
    glyph: "focus", tint: "ochre", frame: "square", accent: "dot",
    desc: "Focus and sweet — patient builder. Slow river, steady cup, finished dam.",
    earned: ctx => onPick(ctx, "focus", ["sweet"]) },
  { id: "spirit-crane",       name: "The Crane",          rarity: "rare", window: "onboarding",
    glyph: "calm", tint: "ochre", frame: "diamond", accent: "rays",
    desc: "Calm and sweet — patient ceremony. The cup folds time like origami.",
    earned: ctx => onPick(ctx, "calm", ["sweet"]) },
  { id: "spirit-stag",        name: "The Stag",           rarity: "rare", window: "onboarding",
    glyph: "warming", tint: "terra", frame: "hex", accent: "star",
    desc: "Calm and spiced — noble ceremony. Antlers carved by every season's cup.",
    earned: ctx => onPick(ctx, "calm", ["spiced"]) },
  { id: "spirit-dove",        name: "The Dove",           rarity: "common", window: "onboarding",
    glyph: "calm", tint: "sage", frame: "circle", accent: "none",
    desc: "Calm and floral — peace, plain and unhurried. The cup is a wing folded.",
    earned: ctx => onPick(ctx, "calm", ["floral"]) },
  { id: "spirit-magpie",      name: "The Magpie",         rarity: "rare", window: "onboarding",
    glyph: "digestive", tint: "ochre", frame: "diamond", accent: "dot",
    desc: "Digestive and sweet — collector of bittersweets. You keep the strange cups others discard.",
    earned: ctx => onPick(ctx, "digestive", ["sweet"]) },
  { id: "spirit-tortoise",    name: "The Tortoise",       rarity: "uncommon", window: "onboarding",
    glyph: "grounding", tint: "ash", frame: "hex", accent: "none",
    desc: "Digestive and earthy — ancient and slow. The cup outlives the rush.",
    earned: ctx => onPick(ctx, "digestive", ["earthy"]) },
  { id: "spirit-heron",       name: "The Heron",          rarity: "rare", window: "onboarding",
    glyph: "calm", tint: "sky", frame: "diamond", accent: "crescent",
    desc: "Calm and minty — patient pond, one foot raised. The cup is what you wait beside.",
    earned: ctx => onPick(ctx, "calm", ["minty"]) },
  { id: "spirit-lark",        name: "The Lark",           rarity: "rare", window: "onboarding",
    glyph: "energy", tint: "ochre", frame: "circle", accent: "rays",
    desc: "Energy and citrus at the morning hour — the singer that meets the sun. Lift carries you.",
    earned: ctx => onPick(ctx, "energy", ["citrus"])
      && ctx.onboarding.times.has("morning") },
  { id: "spirit-bat",         name: "The Bat",            rarity: "legendary", window: "onboarding",
    glyph: "sleepy", tint: "plum", frame: "diamond", accent: "crescent",
    desc: "Sleepy and floral, evenings only — twilight emergence. Petals at the wing's edge.",
    earned: ctx => onPick(ctx, "sleepy", ["floral"])
      && ctx.onboarding.times.has("evening") },
  { id: "spirit-elephant",    name: "The Elephant",       rarity: "rare", window: "onboarding",
