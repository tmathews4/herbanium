...
const INGREDIENTS = {
  ...
  chamomile: {
    ...
    facts: [
      ...
      "The Greek name chamaemelon means 'earth apple' — the scent of crushed leaves genuinely recalls fresh apple.",
      ...
      "Harbourne's 2008 brewing-optimization paper found 90°C for 20 minutes is the maximum-phenol, minimum-turbidity point — the chemist's perfect cup.",
  ...
  passionflower: {
    ...
    facts: [
      ...
      "The name was given by 16th-century Spanish missionaries who saw the flower's structure as a depiction of Christ's crucifixion — the radial corona for the crown of thorns, the three styles for the nails, the five anthers for the wounds.",
      ...
      "The fruit is edible — eaten raw or made into jelly across the southern US — though the leaves and aerial parts are what's used for tea.",
      "Listed in the pharmacopoeias of six countries (UK, France, Germany, Switzerland, Egypt, India) as an approved sedative herb — one of the most institutionally-recognized calming plants.",
      ...
      "Mild but real effect on generalized anxiety in randomized trials — comparable to oxazepam at standard doses, with fewer side effects in the studies that ran the comparison.",
  ...
  lemonbalm: {
    ...
    facts: [
      ...
      "The lemon scent comes from citral, citronellal, and geranial — the same essential-oil profile as lemongrass, just at a lower concentration.",
      ...
      "Crushed leaves repel mosquitoes — the citronellal does the same work as in citronella candles, just at gentler dose.",
      ...
      "The plant self-seeds aggressively and has naturalized across most of Europe, North America, and parts of Asia. Once you have it, you have it.",
    ],
  },
  ...
  peppermint: {
    ...
    facts: [
      ...
      "Mint chocolate is a 19th-century innovation. The flavor combination didn't exist before then; one of the very few flavor-pair traditions younger than two hundred years.",
  ...
  spearmint: {
    ...
    facts: [
      ...
      "The Greek word for mint, minthe, comes from a nymph who was turned into the plant by Persephone — Greek myth's explanation for the smell.",
  ...
  lemongrass: {
    ...
    facts: [
      ...
      "The plant has no actual lemon in it — citral is in lemon zest, in lemon balm, in verbena, in the bark of pau d'arco. 'Lemon' is a chemical signature, not a fruit.",
  ...
  hibiscus: {
    ...
    facts: [
      ...
      "The flowers bloom for a single day each, opening at dawn and wilting by dusk. Commercial harvest is fast — flowers are picked daily through the season.",
  ...
  rooibos: {
    ...
    facts: [
      ...
      "Aspalathin has shown anti-diabetic activity in lab studies — early evidence it may help blood-sugar regulation, though clinical trials in humans are still small.",
  ...
  ashwagandha: {
    ...
    facts: [
      ...
      "The plant is also called 'Indian ginseng,' though it's botanically unrelated to true ginseng (Panax). The naming reflects similar adaptogenic use, not shared chemistry.",
      ...
      "Some studies report mild improvement in muscle strength and recovery in resistance trainers — preliminary, but persistent enough that it shows up as a supplement in athletic stacks.",
      ...
      "The root extract used in most modern studies is KSM-66 — a standardized preparation from a single Indian manufacturer. Most positive trial results trace back to it.",
  ...
  turmeric: {
    ...
    facts: [
      ...
      "Most commercial curcumin supplements use BCM-95 or Meriva or similar liposomal formulations — different preservative packaging meant to bypass the absorption problem.",
  ...
  cinnamon: {
    ...
    facts: [
      ...
      "The bark is harvested by stripping the inner layer from young branches and letting it curl as it dries — the quill shape is the bark drying naturally.",
  ...
  cardamom: {
    ...
    facts: [
      ...
      "The plant grows as an understory in tropical forests; harvesting requires hiking into shade and picking pods individually as they ripen over weeks.",
  ...
  cloves: {
    ...
    facts: [
      ...
      "Eugenol is also the dominant aromatic in carnations, allspice, and bay leaf. Different plants, same warming spice signature.",
  ...
  vanilla: {
    ...
    facts: [
      ...
      "The pods are split and scraped because the seeds (not the pod walls) carry most of the perfume — though commercial extracts use both for full flavor.",
      "Vanillin can be detected by humans at 0.02 parts per billion — one of the strongest aromatic compounds known to the human nose, gram for gram.",
    ],
  },
  "black-pepper": {
  ...
  white: {
    ...
    facts: [
      ...
      "Brews at lower temperatures than green tea — 75-80°C is canonical. Boiling water turns the cup grassy and shortens the lifespan of the leaves.",
  ...
  sencha: {
    ...
    facts: [
      ...
      "The leaves are steamed within hours of picking — Japanese green tea factories are still mostly built next to the fields for this reason.",
  ...
  gyokuro: {
    ...
    facts: [
      ...
      "The shading reduces photosynthesis, which means the plant can't break down theanine into catechins — the umami compound stays in the leaf.",
  ...
  genmaicha: {
    ...
    facts: [
      ...
      "Originally a wartime and post-war frugality drink — rice was cheaper than tea, and the blend made the tea last longer in lean households.",
      ...
      "Brews at slightly higher temperatures than sencha (80-85°C) because the toasted rice tolerates heat better than delicate green leaves.",
      "Frequently the recommended cup for sushi pairings — its toasty depth complements the rice in the food, completing the meal in echo.",
  ...
  gunpowder: {
    ...
    facts: [
      ...
      "The rolling process is mostly mechanized today, but the highest grades are still hand-rolled in small batches for tighter pellets and slower release.",
      ...
      "The strong smoky-grassy character pairs uniquely well with intense mints — most other green teas would buckle under spearmint's full force.",
  ...
  hojicha: {
    ...
    facts: [
      ...
      "The roast time is short — 5-15 minutes at high temperature — but the chemistry is dramatic. Theanine stays mostly intact; caffeine drops by 50-80%.",
  ...
  dragonwell: {
    ...
    facts: [
      ...
      "The flat, sword-blade leaf shape is achieved by pressing the leaves against the curved wok wall during firing — a one-handed technique that takes years to master.",
      ...
      "The chestnut character is dramatically pronounced in Shi Feng village — the highest-altitude site, with the most pan-fire. Other villages produce subtler, sweeter cups.",
  ...
  assam: {
    ...
    facts: [
      ...
      "The Brahmaputra Valley grows over half of India's tea — the climate is hot, humid, low-altitude — opposite the Darjeeling profile and producing opposite tea.",
  ...
  darjeeling: {
    ...
    facts: [
      ...
      "Castleton, Margaret's Hope, and Makaibari are the most famous estates; some single-flush lots fetch $1,000+/kg at auction.",
      ...
      "The tea jassid (Jacobiasca formosana) was historically considered a pest — until growers realized its bites were what produced the muscatel character. Now they tolerate it deliberately.",
  ...
  puerh: {
    ...
    facts: [
      ...
      "The fermenting microbes (Aspergillus niger and others) eat the bitter catechins and produce gentler theaflavins — the same family responsible for black tea's malt.",
  ...
  echinacea: {
    ...
    facts: [
      ...
      "The plant is one of the showiest American natives — the daisy-like purple flowers were exported as ornamentals to Europe in the 18th century, with the medicinal use following decades later.",
  ...
  elderflower: {
    ...
    facts: [
      ...
      "The species name nigra refers to the dark berries, not the tree itself. Bark is gray, leaves are green, flowers are white — only the fruit is genuinely 'black.'",
    ],
    safetyFlags: {
  ...
  linden: {
    ...
    facts: [
      ...
      "The wood is famously soft and even-grained — used for centuries in piano keys, sculpture, and the Stradivarius family of musical instruments.",
      ...
      "The bracts (the modified leaves attached to the flower clusters) are part of what's brewed — they carry mucilage and contribute to the cup's body.",
  ...
  "dandelion-root": {
    ...
    facts: [
      ...
      "The plant's name comes from the French dent de lion ('lion's tooth') — the jagged leaf shape, not the flower or root.",
  ...
  "dandelion-leaf": {
    ...
    facts: [
      ...
      "Spring leaves are sweeter; summer leaves are more bitter; the same plant, different cups across the season.",
      ...
      "The leaves whiten when blanched (covered to exclude light) — the same technique used for endive, removing some of the bitter and changing the texture.",
      "Modern foragers prefer leaves picked from un-treated lawns — the plant accumulates herbicides from chemical lawn care, which is why uncertainty about the source matters.",
  ...
  reishi: {
    ...
    facts: [
      ...
      "The fan-shaped fruiting body is the medicinal part; the mycelium (the underground network) is sometimes substituted in modern supplements but has different chemistry.",
  ...
  "lions-mane": {
    ...
    facts: [
      ...
      "The mushroom genuinely tastes like crab or lobster when cooked — the texture and umami profile is closer to seafood than to other mushrooms.",
      "Hericenones (in the fruiting body) and erinacines (in the mycelium) are different compounds with similar effects — both stimulate NGF production. Supplements vary in which they emphasize.",
      ...
      "The cascading-icicle look is unique among mushrooms — easily identifiable, hard to confuse with toxic look-alikes, which is why it's a frequent forager's first medicinal mushroom.",
