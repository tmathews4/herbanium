...
const INGREDIENTS = {
  ...
  chamomile: {
    ...
    registerZones: [
      { id: "faint",      character: "flavor and effect both held back.", moodImpact: "all moods muted" },
      { id: "aromatic",   character: "honey-floral lift, light on the tongue.", moodImpact: "calm only as a quiet promise" },
      { id: "balanced",   character: "the household calming cup — full character without weight.", moodImpact: "calm and soothing in clean balance" },
      { id: "tonic",      character: "deep, sleep-leaning, apigenin-forward.", moodImpact: "sleepy comes forward; calm at anchor strength" },
      { id: "overpulled", character: "hay-bitter dominates.", moodImpact: "the calm is gone, replaced by edge" },
    ],
  ...
  lavender: {
    ...
    registerZones: [
      { id: "faint",      character: "flavor and effect both held back.", moodImpact: "all moods muted" },
      { id: "aromatic",   character: "soft, perfumed, light.", moodImpact: "calm forward; soothing held back" },
      { id: "balanced",   character: "lavender at its cleanest — bouquet without aggression.", moodImpact: "calm and soothing in clean balance" },
      { id: "tonic",      character: "deep, sleep-leaning, perfume-saturated.", moodImpact: "sleepy creeps in; calm holds at peak" },
      { id: "overpulled", character: "soapy and medicinal — the perfume turned aggressive.", moodImpact: "the calm is gone, edges replace it" },
    ],
  ...
  lemonbalm: {
    ...
    registerZones: [
      { id: "faint",      character: "barely steeped.", moodImpact: "all moods muted" },
      { id: "aromatic",   character: "bright lemon, soft herbal lift.", moodImpact: "uplifting forward; calm gentle" },
      { id: "balanced",   character: "the everyday calming-bright cup.", moodImpact: "uplifting, calm, and soothing in balance" },
      { id: "tonic",      character: "deep, herbal, the calming side full.", moodImpact: "calm deepens; sleepy creeps in" },
      { id: "overpulled", character: "the brightness lost to tannin.", moodImpact: "calm strained; uplifting gone" },
    ],
  ...
  peppermint: {
    ...
    registerZones: [
      { id: "faint",      character: "barely brewed; menthol whispering.", moodImpact: "all moods muted" },
      { id: "aromatic",   character: "bright, clean mint.", moodImpact: "cooling forward; focus clear" },
      { id: "balanced",   character: "the full digestive-cooling household cup.", moodImpact: "cooling, digestive, calm in clean balance" },
      { id: "tonic",      character: "deep, sharp, menthol-saturated.", moodImpact: "cooling at peak; focus and digestive both lifted" },
      { id: "overpulled", character: "harsh, bitter, the mint turned aggressive.", moodImpact: "cooling lost to bitter edge" },
    ],
  ...
  spearmint: {
    ...
    registerZones: [
      { id: "faint",      character: "barely brewed.", moodImpact: "all moods muted" },
      { id: "aromatic",   character: "Maghrebi-bright sweet mint.", moodImpact: "cooling gentle; uplifting forward" },
      { id: "balanced",   character: "the household mint cup — clean, sweet, refreshing.", moodImpact: "cooling, calm, uplifting in balance" },
      { id: "tonic",      character: "deep mint, sweet body, perfume-full.", moodImpact: "cooling deep; calm settles in" },
      { id: "overpulled", character: "the carvone perfume gone, bitter remains.", moodImpact: "cooling lost; cup turns flat" },
    ],
  ...
  lemongrass: {
    ...
    effects: [["cooling", 4], ["uplifting", 4], ["digestive", 3], ["calm", 2]],
  ...
  fennel: {
    ...
    registerZones: [
      { id: "faint",      character: "barely brewed.", moodImpact: "all moods muted" },
      { id: "aromatic",   character: "bright licorice top.", moodImpact: "digestive gentle; cooling clean" },
      { id: "balanced",   character: "the after-dinner Italian household cup.", moodImpact: "digestive, cooling, soothing in balance" },
      { id: "tonic",      character: "deep, full-bodied, the licorice-anise full.", moodImpact: "digestive at peak; cooling and soothing both deep" },
      { id: "overpulled", character: "anise turning bitter, body heavy.", moodImpact: "digestive overdone; cooling fades" },
    ],
  ...
  hibiscus: {
    ...
    tempZones: [
      ...
      { id: "cool",  tempC: [90, 95],  character: "ruby color, gentle tart.", moodImpact: "cooling gentle" },
      { id: "warm",  tempC: [95, 99],  character: "full hibiscus tart, deep ruby.", moodImpact: "cooling forward; digestive solid" },
      { id: "hot",   tempC: [99, 100], character: "sharpest extraction, full grip.", moodImpact: "cooling at peak" },
    ],
    timeZones: [
      { id: "under",  timeS: [0, 120],   character: "color only, no tart yet.", moodImpact: "the cup hasn't found its edge" },
      { id: "short",  timeS: [120, 240], character: "bright ruby, soft tart.", moodImpact: "cooling forward" },
      { id: "medium", timeS: [240, 420], character: "full karkadé character — sharp, ruby, tart.", moodImpact: "the household tart-cooling cup" },
      { id: "long",   timeS: [420, 600], character: "deep tart, color saturated.", moodImpact: "cooling deepens; digestive solid" },
    ...
    registerZones: [
      { id: "faint",      character: "color but no character.", moodImpact: "all moods muted" },
      { id: "aromatic",   character: "ruby-bright, soft tart.", moodImpact: "cooling gentle" },
      { id: "balanced",   character: "the household karkadé cup — sharp, tart, refreshing.", moodImpact: "cooling and digestive in clean balance" },
      { id: "tonic",      character: "deep ruby, sharp-tart, fully saturated.", moodImpact: "cooling at peak; digestive solid" },
      { id: "overpulled", character: "aggressively tart, the cup losing its lift.", moodImpact: "cooling overdone; cup goes flat" },
    ],
  ...
  rooibos: {
    ...
    registerZones: [
      { id: "faint",      character: "barely brewed.", moodImpact: "all moods muted" },
      { id: "aromatic",   character: "lighter red bush, honey-bright.", moodImpact: "soothing gentle; calm starting" },
      { id: "balanced",   character: "the household rooibos cup — soothing at full.", moodImpact: "soothing at anchor strength; digestive solid" },
      { id: "tonic",      character: "deep, full-bodied, honey-warmth.", moodImpact: "soothing deep; grounding lifted" },
  ...
  ginger: {
    ...
    registerZones: [
      { id: "faint",      character: "barely warming.", moodImpact: "all moods muted" },
      { id: "aromatic",   character: "bright, clean ginger top.", moodImpact: "warming gentle; digestive present" },
      { id: "balanced",   character: "the everyday warming cup — clean heat and body.", moodImpact: "warming and digestive in balance" },
      { id: "tonic",      character: "deep ginger decoction, slow-burn warmth.", moodImpact: "warming at peak; soothing and digestive deepen" },
      { id: "overpulled", character: "harsh, biting, the heat turned aggressive.", moodImpact: "warming lost to harsh edge" },
    ],
  ...
  white: {
    ...
    flavors: ["sweet", "hay", "honey", "delicate", "melon", "floral", "apricot"],
    pairs: ["jasmine", "rose"],
    dose: "1–2 tsp · 200ml",
    headsUp: null,
  ...
  sencha: {
    ...
    flavors: ["grassy", "marine", "umami", "vegetal", "fresh", "sweet"],
  ...
  matcha: {
    ...
    registerZones: [
      { id: "faint",      character: "barely whisked.", moodImpact: "all moods muted" },
      { id: "aromatic",   character: "thin, sweet usucha.", moodImpact: "focus and energy crisp" },
      { id: "balanced",   character: "the canonical chanoyu cup.", moodImpact: "focus at anchor strength; calm and energy in balance" },
      { id: "tonic",      character: "thicker koicha territory — full body, less brightness.", moodImpact: "focus deep; energy steady" },
      { id: "overpulled", character: "the bright tea has gone flat.", moodImpact: "focus and brightness both fade" },
    ],
    ...
    flavors: ["umami", "vegetal", "grassy", "sweet", "oceanic", "creamy", "marine"],
  ...
  dragonwell: {
    ...
    flavors: ["nutty", "chestnut", "sweet", "vegetal", "toasted", "fresh", "bean"],
    pairs: ["rose", "jasmine"],
    dose: "1 tsp · 200ml",
    headsUp: null,
  ...
  oolong: {
    ...
    flavors: ["floral", "fruit", "honey", "creamy", "orchid", "peach", "toasted"],
    pairs: ["rose", "jasmine"],
    dose: "1–2 tsp · 200ml",
    headsUp: null,
  ...
  assam: {
    ...
    registerZones: [
      { id: "faint",      character: "barely brewed.", moodImpact: "all moods muted" },
      { id: "aromatic",   character: "lighter Assam, malt-bright.", moodImpact: "energy moderate; warming present" },
      { id: "balanced",   character: "the breakfast cup — full malt, robust grip.", moodImpact: "energy at peak; warming and focus solid" },
      { id: "tonic",      character: "deep, full-bodied, robust tannin.", moodImpact: "energy steady; warming deep" },
  ...
  darjeeling: {
    ...
    registerZones: [
      { id: "faint",      character: "barely brewed.", moodImpact: "all moods muted" },
      { id: "aromatic",   character: "first-flush bright — perfume and muscatel.", moodImpact: "uplifting forward; energy crisp" },
      { id: "balanced",   character: "the canonical Darjeeling cup.", moodImpact: "uplifting at peak; focus and energy in balance" },
      { id: "tonic",      character: "fuller body, perfume backgrounded.", moodImpact: "uplifting moderates; warming arrives" },
  ...
  ceylon: {
    ...
    flavors: ["citrus", "bright", "brisk", "honey", "woody", "spiced"],
  ...
  lapsang: {
    ...
    effects: [["warming", 4], ["grounding", 3], ["energy", 3], ["focus", 2]],
    flavors: ["smoked", "pine", "campfire", "leather", "tar", "woody"],
    pairs: ["rooibos"],
    dose: "1 tsp · 200ml",
    headsUp: null,
  ...
  valerian: {
    ...
    registerZones: [
      { id: "faint",      character: "barely brewed.", moodImpact: "all moods muted" },
      { id: "aromatic",   character: "lighter root, the bedtime herbal cup.", moodImpact: "sleepy gentle; calm settles" },
      { id: "balanced",   character: "the canonical valerian sleep tea.", moodImpact: "sleepy at anchor strength; calm and soothing both solid" },
      { id: "tonic",      character: "deep, heavy, full sedative weight.", moodImpact: "sleepy peak; grounding deep" },
      { id: "overpulled", character: "muddied — the medicine has flattened.", moodImpact: "sleepy still strong but the cup is heavy" },
    ],
  ...
  linden: {
    ...
    effects: [["calm", 4], ["sleepy", 3], ["soothing", 4], ["warming", 1], ["digestive", 1]],
  ...
  nettle: {
    ...
    effects: [["soothing", 4], ["grounding", 2], ["digestive", 2], ["calm", 1], ["warming", 1]],
  ...
  sage: {
    ...
    effects: [["focus", 2], ["soothing", 2], ["digestive", 2], ["warming", 1]],
  ...
  reishi: {
    ...
    registerZones: [
      { id: "faint",      character: "barely brewed.", moodImpact: "all moods muted" },
      { id: "aromatic",   character: "lighter mushroom water, the medicine still arriving.", moodImpact: "grounding gentle" },
      { id: "balanced",   character: "the canonical reishi decoction — bitter, earthy, full.", moodImpact: "grounding at anchor strength; calm and soothing solid" },
      { id: "tonic",      character: "deepest decoction — the full Ling Zhi register.", moodImpact: "grounding deep; sleepy arrives; calm at peak" },
      { id: "overpulled", character: "very heavy, body almost broth-thick.", moodImpact: "grounding holds; cup is meditative-heavy" },
    ],
  ...
  "lions-mane": {
    ...
    effects: [["focus", 3], ["calm", 2], ["uplifting", 2], ["grounding", 2], ["digestive", 2]],
