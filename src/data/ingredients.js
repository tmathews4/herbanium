...
const INGREDIENTS = {
  ...
  lavender: {
    ...
    facts: [
      ...
      "Aromatic compounds genuinely survive in sealed Egyptian tombs — myrtle and immortelle have been detected in funerary material after nearly two thousand years. What Howard Carter smelled on opening Tutankhamun's jars was mummification balm, a blend, not any one flower.",
    ],
  },
  rose: {
  ...
  passionflower: {
    ...
    facts: [
      ...
      "Cherokee, Houma and Seminole peoples used passionflower for anxiety and sleeplessness long before Europeans met it — the Spanish missionaries who named it for the Passion in the 1500s were renaming a medicine, not finding one.",
  ...
  lemonbalm: {
    ...
    facts: [
      ...
      "Carmelite Water, a lemon-balm tonic, became one of Europe's most popular nerve remedies — the famous formulation set down by Discalced Carmelite friars in Paris in 1611, on an older recipe tradition credits to Carmelite nuns. Still sold today.",
      ...
      "Charlemagne's Capitulare de villis lists lemon balm among the plants every royal estate was to grow — pharmaceutical infrastructure as imperial policy, around the turn of the ninth century.",
  ...
  rooibos: {
    ...
    facts: [
      ...
      "Rooibos won EU Protected Designation of Origin status in 2021 — the first African product to get it. Only leaf grown in the Cederberg and its neighbouring districts may carry the name.",
  ...
  ginger: {
    ...
    facts: [
      ...
      "Candying ginger goes back to Song-dynasty China, where it began as a way to keep the root through the year — sugar as preservation first, confection second.",
  ...
  turmeric: {
    ...
    facts: [
      ...
      "Curcumin barely absorbs on its own, so the supplement trade sells delivery systems rather than curcumin: BCM-95 pairs it with turmeric's own essential oils, Meriva binds it to phospholipid, others use nanoparticle dispersions. Each reports several-fold better plasma levels than plain extract. A cup of tea has none of that engineering.",
      "Persian medicine has used turmeric for liver complaints for over a millennium, and trials in fatty liver disease do find improvements in liver enzymes. The evidence runs both ways, though: concentrated turmeric supplements have been implicated in dozens of cases of acute liver injury. The tradition is real; the extract is not automatically the gentle option.",
  ...
  cloves: {
    ...
    facts: [
      ...
      "The clove tree called Afo, on Ternate, stood more than 400 years before being cut up for firewood early this century; its remains sit behind a brick wall and a roughly 230-year-old successor still stands. Tradition holds that Poivre's stolen seedlings came from it.",
      ...
      "Clove oil is strongly antimicrobial, and eugenol is why — though in head-to-head comparisons against food-borne bacteria it does not lead the field: cinnamon oil usually does, and one study of the three ranked clove last.",
  ...
  vanilla: {
    ...
    facts: [
      ...
      "Vanilla planifolia is propagated by cutting, not seed — so the vines spreading worldwide after Albius's 1841 technique were largely one clonal line, and still are. Genomic surveys find almost no variation across the cultivated crop, which is why Fusarium rot has been able to halve world production.",
  ...
  "black-pepper": {
    ...
    flavors: ["pungent", "hot", "earthy", "woody", "citrus"],
    ...
    facts: [
      ...
      "Alaric's Visigoths lifted their siege of Rome in 408 CE for a ransom that included 3,000 pounds of pepper — alongside 5,000 pounds of gold and 30,000 of silver. Pepper was the smallest line on the bill and still worth naming.",
  ...
  white: {
    ...
    facts: [
      ...
      "Silver Needle as we know it dates to about 1796 in Fuding — the 'ancient imperial tea' framing sold alongside it is mostly 20th-century romanticization, and younger than the tea it advertises.",
      ...
      "Modern interest in white tea exploded after a 2004 Pace University paper, presented at a microbiology meeting rather than peer-reviewed, claimed stronger antibacterial effects than green tea — methodologically thin but commercially decisive.",
  ...
  genmaicha: {
    ...
    effects: [["calm", 4], ["comfort", 3], ["focus", 2], ["warming", 2], ["digestive", 2]],
    flavors: ["nutty", "rice", "grassy", "sweet", "warm", "savory"],
  ...
  gunpowder: {
    ...
    flavors: ["toasted", "mineral", "vegetal", "bold", "brisk"],
  ...
  hojicha: {
    ...
    facts: [
      ...
      "Hojicha itself is a Kyoto invention of the 1920s — roasting the stems and coarse leaf that were too low-grade to sell. The latte is much newer: a mid-2010s boom across Japanese cafes, because the toasty character pairs with milk in a way most green teas don't.",
  ...
  oolong: {
    ...
    facts: [
      ...
      "Oolong emerged in the Fujian hills in the 17th or 18th century — Wuyishan and Anxi both claim it, and the record does not settle which. It is younger than green tea by centuries and was made by pushing oxidation partway, then stopping.",
  ...
  assam: {
    ...
    facts: [
      ...
      "Robert Bruce, a Scottish adventurer, was shown Assam's wild tea in 1823 by the Singpho chief Bessa Gam — an introduction arranged by the Ahom nobleman Maniram Dewan. The plant did not need finding; the Singpho had used it for centuries.",
  ...
  ceylon: {
    ...
    facts: [
      ...
      "Sri Lanka first became the world's largest tea exporter in 1965 and held that place for decades before Kenya overtook it; the island still produces around 260,000 tonnes a year.",
  ...
  "yerba-mate": {
    ...
    facts: [
      ...
      "Some studies link very hot mate consumption to esophageal cancer risk — but the evidence points at the heat rather than the leaf — drinks above about 65°C are what carry the risk, and cold mate shows no such association.",
    ],
    safetyFlags: {
      caffeine: "moderate",
  ...
  echinacea: {
    ...
    flavors: ["earthy", "grassy", "bitter", "floral"],
  ...
  elderflower: {
    ...
    flavors: ["floral", "lychee", "sweet", "delicate"],
  ...
  linden: {
    ...
    flavors: ["honey-sweet", "citrusy", "floral", "delicate"],
  ...
  sage: {
    ...
    effects: [["focus", 2], ["soothing", 2], ["digestive", 2]],
    ...
    facts: [
      ...
      "Sage is one of the herbs in the vinaigre des quatre voleurs — 'four thieves vinegar' — the plague-era infusion grave robbers were said to have used to rob the dying without catching it. The four were the THIEVES, not the herbs: early recipes run to a dozen or more.",
      ...
      "Charlemagne ordered sage planted in every royal estate's garden in his Capitulare de villis — a list of 90+ plants the empire considered essential, issued around the turn of the ninth century. Sage's place in European herbalism has been continuous ever since.",
    ],
  },
  ...
  "orange-peel": {
    ...
    facts: [
      ...
      "Spiced wine is genuinely ancient — the Roman conditum paradoxum, then medieval hippocras, which leaned on cinnamon, ginger, clove and grains of paradise. Citrus is the late arrival: fruit-led spiced wines appear from the 17th century on, so the orange in a modern Glühwein is the newest part of a very old drink.",
  ...
  reishi: {
    ...
    effects: [["grounding", 5], ["sleepy", 4], ["calm", 4], ["immune", 4]],
    flavors: ["bitter", "earthy", "woody", "mushroomy"],
  ...
  "lions-mane": {
    ...
    effects: [["focus", 3], ["calm", 2], ["grounding", 2], ["digestive", 2]],
