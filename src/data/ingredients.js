...
const INGREDIENTS = {
  ...
  hibiscus: {
    ...
    registerZones: [
      ...
      { id: "aromatic",   character: "ruby-bright, soft tart.", moodImpact: "cooling gentle; uplifting present" },
      { id: "balanced",   character: "the household karkadé cup — sharp, tart, refreshing.", moodImpact: "cooling and digestive in clean balance" },
      { id: "tonic",      character: "deep ruby, sharp-tart, fully saturated.", moodImpact: "cooling at peak; energy and digestive both lifted" },
      { id: "overpulled", character: "aggressively tart, the cup losing its lift.", moodImpact: "cooling overdone; uplifting fades" },
    ],
