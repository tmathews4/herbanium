...
export const EXTRACTION_PROFILES = {
  ...
  bergamot: [
    ...
    { tempC: 95,  timeS: 300, flavors: ["citrus", "bergamot", "floral", "bright", "aromatic", "heady"],
      effects: [["uplifting", 3], ["calm", 2], ["cooling", 1]],
      character: "The Earl Grey signature — fragrant citrus and floral oil." },
    { tempC: 100, timeS: 420, flavors: ["citrus", "bergamot", "bright", "aromatic", "pith", "bitter", "heady"],
  ...
  "orange-peel": [
    ...
    { tempC: 96,  timeS: 360, flavors: ["citrus", "orange", "sweet", "aromatic", "warm", "bittersweet"],
      effects: [["uplifting", 2], ["digestive", 2], ["comfort", 1]],
      character: "The standard cup. Full orange character — sun-warm and rounded." },
    { tempC: 100, timeS: 480, flavors: ["citrus", "orange", "aromatic", "warm", "pith", "bitter", "bittersweet"],
  ...
  "dried-apple": [
    ...
    { tempC: 96,  timeS: 480, flavors: ["sweet", "fruity", "apple", "honeyed", "hay", "honey"],
      effects: [["comfort", 3], ["calm", 2]],
      character: "The standard cup. Full dried-apple — honey-sweet, compote depth." },
    { tempC: 100, timeS: 600, flavors: ["sweet", "fruity", "apple", "honeyed", "hay", "tart", "honey"],
      effects: [["comfort", 3], ["calm", 2]],
