...
export const EXTRACTION_PROFILES = {
  ...
  lavender: [
    ...
    { tempC: 90,  timeS: 300, flavors: ["floral", "pine"],
      effects: [["calm", 4], ["sleepy", 2], ["comfort", 2]],
      character: "The culinary cup. Floral and balanced, solid calm." },
    { tempC: 95,  timeS: 360, flavors: ["floral", "pine", "camphor", "soapy"],
  ...
  ginger: [
    { tempC: 100, timeS: 300, flavors: ["spiced", "warm"],
      effects: [["warming", 4], ["digestive", 3], ["energy", 1]],
    ...
    { tempC: 100, timeS: 600, flavors: ["spiced", "warm", "citrus", "sharp", "harsh"],
      effects: [["warming", 5], ["digestive", 4], ["energy", 2], ["bitterness", 2], ["grounding", 2]],
  ...
  cloves: [
    ...
    { tempC: 100,  timeS: 600, flavors: ["spiced", "pungent", "warm", "numbing", "medicinal"],
      effects: [["warming", 4], ["digestive", 3], ["bitterness", 3], ["grounding", 3], ["soothing", 2]],
  ...
  fennel: [
    { tempC: 90,  timeS: 240, flavors: ["licorice", "sweet"],
      effects: [["digestive", 2], ["cooling", 1], ["soothing", 1], ["warming", 1]],
      character: "Light fennel — sweet anise, clean and gentle." },
    { tempC: 95,  timeS: 480, flavors: ["licorice", "sweet", "aromatic"],
      effects: [["digestive", 4], ["cooling", 2], ["soothing", 2], ["calm", 1], ["warming", 2]],
      character: "The standard cup. Full fennel character — digestive and soothing." },
    { tempC: 100,  timeS: 600, flavors: ["licorice", "sweet", "aromatic", "bitter"],
  ...
  gunpowder: [
    ...
    { tempC: 85,  timeS: 150,
      ...
      effects: [["focus", 3], ["calm", 1.5], ["energy", 3], ["warming", 1], ["digestive", 2]],
    ...
    { tempC: 90,  timeS: 180,
      ...
      effects: [["focus", 3], ["energy", 4], ["bitterness", 2], ["warming", 1], ["digestive", 2]],
  ...
  assam: [
    { tempC: 95,  timeS: 120, flavors: ["malty", "bold", "warm"],
      effects: [["energy", 3], ["focus", 2], ["warming", 4]],
  ...
  "black-pepper": [
    ...
    { tempC: 98,  timeS: 600, flavors: ["pungent", "warm", "earthy", "woody", "hot", "citrus"],
    ...
    { tempC: 100, timeS: 900, flavors: ["pungent", "warm", "earthy", "woody", "harsh", "hot", "citrus"],
  ...
  genmaicha: [
    ...
    { tempC: 78, timeS: 105, flavors: ["toasted", "rice", "nutty", "warm", "grassy", "sweet"],
      effects: [["comfort", 3], ["calm", 3], ["focus", 3], ["digestive", 2], ["energy", 2], ["warming", 2]],
      character: "The standard cup. Toasted rice forward, sencha grass underneath, warm and comforting." },
    { tempC: 85, timeS: 150, flavors: ["toasted", "rice", "nutty", "warm", "grassy", "astringent", "sweet", "savory"],
      effects: [["comfort", 3], ["calm", 3], ["focus", 2], ["digestive", 2], ["bitterness", 2], ["energy", 3], ["warming", 2]],
    ...
    { tempC: 95, timeS: 180,
      ...
      effects: [["comfort", 2], ["energy", 3], ["bitterness", 2.5], ["focus", 3], ["calm", 2], ["warming", 2]],
  ...
  linden: [
    { tempC: 85, timeS: 300, flavors: ["honey", "floral", "honey-sweet", "citrusy", "delicate"],
      effects: [["calm", 2], ["sleepy", 1], ["soothing", 2], ["uplifting", 2]],
      character: "Light linden — soft honey-floral, just the perfume." },
    { tempC: 90, timeS: 450, flavors: ["honey", "citrus", "floral", "sweet", "honey-sweet", "citrusy", "delicate"],
      effects: [["calm", 3], ["sleepy", 2], ["soothing", 3], ["uplifting", 2], ["warming", 1], ["cooling", 1], ["digestive", 1]],
      character: "The standard tisane. Full honey-citrus body, the European pediatric cup." },
    { tempC: 95, timeS: 600, flavors: ["honey", "citrus", "floral", "sweet", "astringent", "honey-sweet", "citrusy", "delicate"],
      effects: [["calm", 4], ["sleepy", 3], ["bitterness", 2], ["soothing", 3], ["warming", 1]],
      character: "Pushed too long. Honey-floral fades; the green-leaf side turns tannic." },
  ],

  // ─── Immune-support florals ─────────────────────────────────
  echinacea: [
    { tempC: 90,  timeS: 300, flavors: ["earthy", "grassy", "herbal", "floral"],
      effects: [["immune", 1], ["uplifting", 1]],
      character: "Light echinacea — a gentle herbal wash." },
    { tempC: 95,  timeS: 600, flavors: ["earthy", "grassy", "herbal", "tingling", "musky", "floral"],
      effects: [["digestive", 1], ["immune", 2], ["warming", 1], ["uplifting", 1]],
      character: "The standard cup. Alkamides surface — that distinctive tongue tingle." },
    { tempC: 100, timeS: 900, flavors: ["earthy", "grassy", "herbal", "tingling", "musky", "bitter", "floral"],
      effects: [["bitterness", 1], ["immune", 2], ["warming", 1], ["digestive", 1]],
      character: "Pushed. Tingling intensifies; faint bitter edge." },
  ],

  elderflower: [
    { tempC: 85, timeS: 300, flavors: ["floral", "fruity", "delicate"],
      effects: [["immune", 2], ["uplifting", 2], ["warming", 1]],
      character: "Light elderflower — delicate muscat aromatics." },
    { tempC: 90, timeS: 450, flavors: ["floral", "muscatel", "fruity", "sweet", "lychee", "delicate"],
      effects: [["calm", 1], ["uplifting", 2], ["immune", 3], ["warming", 1], ["cooling", 1], ["digestive", 1]],
      character: "The standard cup. Full lychee-muscat lift — the European cold-care." },
    { tempC: 95, timeS: 600, flavors: ["floral", "muscatel", "fruity", "sweet", "astringent", "lychee", "delicate"],
      effects: [["uplifting", 2], ["bitterness", 2], ["immune", 3], ["warming", 2], ["cooling", 1], ["digestive", 1]],
  ...
  nettle: [
    ...
    { tempC: 98,  timeS: 600, flavors: ["earthy", "grassy", "mineral", "vegetal", "spinach-like"],
      effects: [["digestive", 2], ["soothing", 3], ["calm", 3], ["warming", 1], ["grounding", 2], ["uplifting", 1]],
    ...
    { tempC: 100, timeS: 900, flavors: ["earthy", "grassy", "mineral", "vegetal", "sweet", "astringent"],
      effects: [["digestive", 2], ["bitterness", 2], ["soothing", 3], ["grounding", 2], ["uplifting", 1], ["calm", 1], ["warming", 1]],
  ...
  "dandelion-root": [
    ...
    { tempC: 95,  timeS: 600,  flavors: ["caramel", "nutty", "caramel-roasted"],
      effects: [["digestive", 2], ["warming", 1], ["grounding", 1]],
      character: "Light dandelion — toasted root warmth, gentle bittersweet." },
    { tempC: 98,  timeS: 1200, flavors: ["caramel", "nutty", "bittersweet", "earthy", "caramel-roasted", "coffee-adjacent"],
    ...
    { tempC: 100, timeS: 1800, flavors: ["caramel", "nutty", "bittersweet", "earthy", "astringent", "caramel-roasted", "coffee-adjacent"],
      effects: [["digestive", 3], ["bitterness", 2], ["warming", 2], ["grounding", 2]],
  ...
  "lions-mane": [
    ...
    { tempC: 95,  timeS: 1200, flavors: ["sweet", "umami", "earthy", "nutty"],
      effects: [["focus", 3], ["calm", 1], ["grounding", 1], ["digestive", 2]],
  ...
  // ─── Dried fruit ──────────────────────────────────────────────
  "dried-apple": [
    { tempC: 90,  timeS: 300, flavors: ["sweet", "fruity", "apple"],
      effects: [["comfort", 1]],
      character: "Light apple — soft sweetness, faint orchard fruit." },
    { tempC: 95,  timeS: 360, flavors: ["sweet", "fruity", "apple", "honeyed", "hay", "honey"],
      effects: [["comfort", 1], ["calm", 2]],
      character: "The standard cup. Full dried-apple — honey-sweet, compote depth." },
    { tempC: 100,  timeS: 420, flavors: ["sweet", "fruity", "apple", "honeyed", "hay", "tart", "honey"],
      effects: [["comfort", 1], ["calm", 2]],
  ...
  cranberry: [
    ...
    { tempC: 96,  timeS: 360, flavors: ["tart", "fruity", "berry", "bright"],
      effects: [["uplifting", 1], ["cooling", 1]],
      character: "The standard cup. Full cranberry — ruby color, tart-sweet bite." },
    { tempC: 100, timeS: 480, flavors: ["tart", "fruity", "berry", "astringent"],
