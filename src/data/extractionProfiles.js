...
export const EXTRACTION_PROFILES = {
  ...
  rooibos: [
    ...
    { tempC: 98,  timeS: 360, flavors: ["honey", "woody", "vanilla", "warm"],
      effects: [["comfort", 4], ["soothing", 3], ["digestive", 3], ["grounding", 3]],
  ...
  vanilla: [
    { tempC: 95,  timeS: 240, flavors: ["sweet", "creamy"],
      effects: [["comfort", 3], ["digestive", 2], ["soothing", 4], ["calm", 1], ["sleepy", 2], ["uplifting", 1]],
      character: "Light vanilla — soft sweetness, a gentle comfort." },
    { tempC: 98,  timeS: 360, flavors: ["sweet", "creamy", "floral", "warm"],
      effects: [["comfort", 4], ["digestive", 3], ["soothing", 3], ["calm", 3], ["sleepy", 2], ["uplifting", 2]],
  ...
  gunpowder: [
    ...
    { tempC: 85,  timeS: 150,
      ...
      effects: [["focus", 3], ["calm", 1.5], ["energy", 3], ["comfort", 2], ["digestive", 2]],
    ...
    { tempC: 90,  timeS: 180,
      ...
      effects: [["focus", 3], ["energy", 4], ["comfort", 2], ["bitterness", 2], ["digestive", 2]],
  ...
  hojicha: [
    ...
    { tempC: 90,  timeS: 30,
      ...
      effects: [["comfort", 3], ["calm", 2], ["digestive", 2], ["soothing", 4], ["grounding", 2]],
    ...
    { tempC: 95,  timeS: 45,
      ...
      effects: [["comfort", 3], ["calm", 2.5], ["digestive", 2.6], ["soothing", 4], ["grounding", 2]],
    ...
    { tempC: 98,  timeS: 60,
      ...
      effects: [["comfort", 4], ["calm", 3], ["digestive", 3], ["soothing", 4], ["grounding", 3]],
  ...
  oolong: [
    ...
    { tempC: 90,  timeS: 135, flavors: ["floral", "honey", "fruit", "orchid", "peach", "creamy", "toasted"],
      effects: [["focus", 3], ["calm", 2], ["energy", 3], ["comfort", 2], ["uplifting", 3]],
    ...
    { tempC: 95,  timeS: 180, flavors: ["floral", "honey", "fruit", "peach", "toasted", "mineral", "astringent"],
      effects: [["focus", 3], ["calm", 1], ["energy", 3], ["comfort", 4], ["bitterness", 2], ["grounding", 2]],
  ...
  assam: [
    { tempC: 95,  timeS: 120, flavors: ["malty", "bold", "warm"],
      effects: [["energy", 3], ["focus", 2], ["comfort", 4]],
    ...
    { tempC: 100, timeS: 300, flavors: ["malty", "bold", "robust", "brisk", "cocoa", "woody", "astringent"],
      effects: [["energy", 5], ["focus", 3], ["comfort", 5], ["bitterness", 2]],
  ...
  ceylon: [
    { tempC: 95,  timeS: 120, flavors: ["citrus", "bright", "honey"],
      effects: [["energy", 2], ["focus", 2], ["comfort", 3], ["uplifting", 3]],
    ...
    { tempC: 98,  timeS: 200, flavors: ["citrus", "bright", "brisk", "honey", "woody", "spiced"],
      effects: [["energy", 3], ["focus", 3], ["comfort", 3], ["uplifting", 3]],
    ...
    { tempC: 100, timeS: 240, flavors: ["citrus", "bright", "brisk", "honey", "woody", "spiced", "astringent"],
      effects: [["energy", 3], ["focus", 2], ["comfort", 4], ["bitterness", 2], ["uplifting", 3]],
  ...
  "licorice-root": [
    ...
    { tempC: 98,  timeS: 600, flavors: ["sweet", "anise", "woody", "earthy"],
      effects: [["comfort", 3], ["digestive", 2], ["soothing", 3], ["grounding", 2], ["uplifting", 1], ["calm", 1]],
    ...
    { tempC: 100, timeS: 900, flavors: ["sweet", "anise", "woody", "earthy", "bitter"],
      effects: [["comfort", 4], ["digestive", 2], ["bitterness", 1], ["soothing", 4]],
  ...
  linden: [
    ...
    { tempC: 90, timeS: 450, flavors: ["honey", "citrus", "floral", "sweet"],
      effects: [["calm", 3], ["sleepy", 2], ["comfort", 2], ["soothing", 3], ["uplifting", 2], ["cooling", 1], ["digestive", 1]],
    ...
    { tempC: 95, timeS: 600, flavors: ["honey", "citrus", "floral", "sweet", "astringent"],
      effects: [["calm", 4], ["sleepy", 3], ["comfort", 3], ["bitterness", 2], ["soothing", 3]],
  ...
  echinacea: [
    ...
    { tempC: 95,  timeS: 600, flavors: ["earthy", "grassy", "herbal", "tingling", "musky"],
      effects: [["comfort", 2], ["digestive", 1], ["soothing", 2], ["uplifting", 1]],
  ...
  elderflower: [
    ...
    { tempC: 95, timeS: 600, flavors: ["floral", "muscatel", "fruity", "sweet", "astringent"],
      effects: [["comfort", 3], ["calm", 2], ["uplifting", 2], ["bitterness", 2], ["soothing", 3], ["cooling", 1], ["digestive", 1]],
  ...
  nettle: [
    ...
    { tempC: 98,  timeS: 600, flavors: ["earthy", "grassy", "mineral", "vegetal", "spinach-like"],
      effects: [["comfort", 3], ["digestive", 2], ["soothing", 3], ["calm", 3], ["sleepy", 2], ["grounding", 2], ["uplifting", 1]],
    ...
    { tempC: 100, timeS: 900, flavors: ["earthy", "grassy", "mineral", "vegetal", "sweet", "astringent"],
      effects: [["comfort", 3], ["digestive", 2], ["bitterness", 2], ["soothing", 3], ["grounding", 2], ["uplifting", 1], ["calm", 1]],
  ...
  "dandelion-root": [
    ...
    { tempC: 95,  timeS: 600,  flavors: ["caramel", "nutty"],
      effects: [["digestive", 2], ["comfort", 1], ["grounding", 1]],
    ...
    { tempC: 98,  timeS: 1200, flavors: ["caramel", "nutty", "bittersweet", "earthy"],
      effects: [["digestive", 3], ["comfort", 2], ["grounding", 2], ["soothing", 1], ["energy", 1], ["focus", 1]],
    ...
    { tempC: 100, timeS: 1800, flavors: ["caramel", "nutty", "bittersweet", "earthy", "astringent"],
      effects: [["digestive", 3], ["comfort", 2], ["bitterness", 2], ["grounding", 2]],
