...
/* ──────────────────────────────────────────────────────────────
   Component: FACTS CARD
   A single-fact-at-a-time reader. Tap to advance through the list,
   cycling back to the first. No auto-advance — facts are read at
   the user's pace, unlike the Steep screen's wait cards which
   rotate on a timer.
   ────────────────────────────────────────────────────────────── */
